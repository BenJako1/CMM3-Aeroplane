...
#initial guesses CM0 and CMa
#CM_func is the function to be fitted
#alpha_list is the independent variable x axis
#CM_List is the dependent variable y axis
#p0 is the initial guess. We are guessing [a,b]=[CM0, CMa]
CM0 = 0.0
CMa = -0.06
def CM_func(x, a, b):
    return a + b * x
